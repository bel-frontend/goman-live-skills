#!/usr/bin/env node
// Get all translation namespaces in your application
//
// Required env vars:
...
//
// Usage:
//   GOMAN_API_KEY=xxx GOMAN_APP_ID=yyy node goman-namespaces.js
...
const res = await fetch(`${API_BASE}/namespaces-mcp`, {
  headers: {
