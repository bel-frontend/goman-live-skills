#!/usr/bin/env node
// Permanently delete all translations for a key
//
// ⚠️  WARNING: This is PERMANENT and cannot be undone!
// Deletes ALL language translations for this key.
//
// Required env vars:
...
if (!fullKey || !fullKey.includes('.')) {
  ...
  console.error('Usage: node goman-delete.js <fullKey>');
  process.exit(1);
}
...
const res = await fetch(`${API_BASE}/delete-localization-mcp/${namespace}/${key}`, {
  method: 'DELETE',
  headers: {
